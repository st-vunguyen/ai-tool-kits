...
> **Purpose:** Show how the example files in `data/samples/` map to common API testing domains.
...
- **Sample file:** `result/<output-slug>/07-data/samples/<file>.json`
- **Source spec:** `result/<output-slug>/source/openapi.yaml`
...
- `result/<output-slug>/02-strategy/`
- `result/<output-slug>/03-scenarios/`
- `result/<output-slug>/04-traceability/`
- `result/<output-slug>/05-postman/collection.json`
