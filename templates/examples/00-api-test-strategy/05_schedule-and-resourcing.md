...
| Week 3 | High-risk expansion | Integration flows, regression subset, runtime runner setup |
...
| Tooling Owner | Local/container runner setup, secret handling approach, artifact retention |
