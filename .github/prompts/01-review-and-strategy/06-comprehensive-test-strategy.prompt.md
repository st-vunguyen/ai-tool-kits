...
- plan coverage for all evidenced response codes, not only happy-path success
...
4. `03_test-cases-priority.md`
   ...
   - operation-by-status priorities for the most important APIs
...
7. `06_traceability.md`
   ...
   - method/path to response-code family to test-line mapping for critical operations
...
8. `07_risks-gaps-open-questions.md`
   ...
   - undocumented or unsupported status codes and missing error examples when present
...
- [ ] Critical APIs have planned coverage beyond a single success code
