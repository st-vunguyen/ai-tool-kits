...
Your task is to establish a standard, reproducible JMeter stack for this API testing pack.
...
Create or refresh these files under `result/<OUTPUT_SLUG>/09-performance/jmeter/`:
...
# Procedure
1. Inspect the existing performance baseline under `result/<OUTPUT_SLUG>/09-performance/`.
