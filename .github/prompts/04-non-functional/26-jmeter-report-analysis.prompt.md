...
- `OUTPUT_SLUG`
- `RUN_SLUG`
- `RAW_REPORT_ROOT`: example `result/<OUTPUT_SLUG>/10-reports/raw/performance/jmeter/<RUN_SLUG>/`
- `CURATED_REPORT_ROOT`: example `result/<OUTPUT_SLUG>/10-reports/performance/jmeter/<RUN_SLUG>/`
...
2. `results.csv`
3. `jmeter.log`
4. any curated threshold or scenario notes from `result/<OUTPUT_SLUG>/`

# Required Output Files
Create or refresh:

- `result/<OUTPUT_SLUG>/10-reports/performance/jmeter/<RUN_SLUG>/00_index.md`
- `result/<OUTPUT_SLUG>/10-reports/performance/jmeter/<RUN_SLUG>/01_executive-summary.md`
- `result/<OUTPUT_SLUG>/10-reports/performance/jmeter/<RUN_SLUG>/02_transaction-breakdown.md`
